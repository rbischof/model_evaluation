...
def _display_taylor_diagram_options():
    ...
    _dispopt("'markerColor'",'Single color to use for all markers'  +
        ' (Default: red)')
    _dispopt("'markerColors'", 'List of colors to use per marker'  + 
    ...
    _dispopt("'markerSymbols'","List of symbols to use per marker symbol" + 
        ' (Default: o,P,X,v,^,>,<)')
    ...
    _dispopt("'labelRMS'","RMS axis label (Default 'RMSE')")
    ...
    _dispopt("'colCOR'",'CORRELATION grid color. Default: black')
