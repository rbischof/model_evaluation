...
def get_taylor_diagram_options(*args,**kwargs):
    ...
    *kwargs : variable-length keyword argument list. The keywords by 
    ...
    option['markercolors']    : list of colors, one per marker (Default: ['b','r','g','c','m','y','k'])
    ...
    option['markersymbols']   : list of symbols, one per marker (Default ['o','P','X','v','^','>','<'])
